...
| Contrato temporal P4 (`PredictionPoint` + `replay` + adapters) | predictor_core + F1/LoL/CS | f1-predictor, lol-predictor, cs-predictor | Pilotos e consolidação concluídos em 2026-08-11 | CORE_CONTRACT_ALREADY_SUFFICIENT / CONSUMER_LOCAL | Core existente + adapters locais | `P4_COMPLETED_NO_CORE_CHANGE`; canonicalização/hash é `REUSABLE_PATTERN_NOT_CORE_READY`; ver `P4_CONSOLIDATION.md` |
